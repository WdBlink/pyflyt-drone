...
# 默认评估配置
EVAL_CONFIG = {
    "model_path": "models/vtail_obj_lock_only_ppo_v1_hist/best_model.zip",
...
def make_eval_env(render_mode="human"):
    ...
    env = FixedwingObjLockEnv(
        ...
        drone_model=EVAL_CONFIG.get("drone_model", None),
        drone_model_dir=EVAL_CONFIG.get("drone_model_dir", None),
